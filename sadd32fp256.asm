;file:          sadd32fp256.asm
;
; Assembly function that adds a 32bit floating point scalar to the
...
; w = address to resulting sum tensor           --> rcx
...
loop4:
    ...
    addss       xmm0,[rdx]                      ; process looped stage 4
