;file:          ssub64fp256.asm
;
; Assembly function that subtracts a 64bit floating point scalar from the
...
; extern(C) 
; double * ssub64fp256(ulong N, double *u, double *s, double *w);
...
loop4:
    ...
    subsd       xmm0,[rdx]                      ; process looped stage 4
