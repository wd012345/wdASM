;file:          sdiv64fp256.asm
;
; Assembly function that divides 64bit floating point components of a 
; tensor with a 64bit floating point scalar according to:
;     w_{111...} = u_{111...} / s
;     w_{211...} = u_{211...} / s
;           .
;           .
...
loop1:
    ...
    vdivpd      ymm0,ymm1,ymm15                 ; process looped stage 1
    vdivpd      ymm2,ymm3,ymm15
    vdivpd      ymm4,ymm5,ymm15
    vdivpd      ymm6,ymm7,ymm15
    vdivpd      ymm8,ymm9,ymm15
    vdivpd      ymm10,ymm11,ymm15
    vdivpd      ymm12,ymm13,ymm15
...
loop4:
    ...
    divsd       xmm0,[rdx]                      ; process looped stage 4
